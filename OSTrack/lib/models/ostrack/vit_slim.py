...
from .slim_layers import ModuleInjection, Attention
...
class VisionTransformer(BaseBackbone, BaseModel):
    """ Vision Transformer
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, weight_init='', head_search = None, uniform_search = None):
        """
        Args:
        ...
        self.blocks = nn.Sequential(*[
            Block(
                ...
                attn_drop=attn_drop_rate, drop_path=dpr[i], norm_layer=norm_layer, act_layer=act_layer, head_search = head_search, uniform_search = uniform_search)
...
def vit_base_patch16_224_slim(pretrained=False, **kwargs):
    """
