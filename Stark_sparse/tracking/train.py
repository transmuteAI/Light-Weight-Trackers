...
#     parser.add_argument('--master_addr', type=str, help="Address")
    parser.add_argument('--master_port', type=int, help="Port")
...
def main():
    ...
    if args.mode == "single":
        ...
        train_cmd = "python -m torch.distributed.launch --nproc_per_node %d --master_port %d lib/train/run_training.py " \
                    ...
                    % (args.nproc_per_node,args.master_port,args.script, args.config, args.save_dir, args.use_lmdb, args.script_prv,
