...
def evaluate(model, search, seq_dict, run_box_head, run_cls_head):
    ...
    flops1 = FlopCountAnalysis(model,[search, None, "backbone", False, False])
    print(flops1.total())
    ...
    flops2 = FlopCountAnalysis(model, (None, seq_dict, "transformer", True, True))
    print(flops2.total())
    ...
    flops = clever_format(flops1 + flops2, "%.3f")
    print(flops)
