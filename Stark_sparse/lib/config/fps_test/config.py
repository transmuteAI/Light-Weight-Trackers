...
# cfg.MODEL.HEAD_SEARCH = False
# cfg.MODEL.UNIFORM_SEARCH = False
# cfg.MODEL.CHILD = True
# cfg.MODEL.BUDGET_ATTN = 0.5
# cfg.MODEL.BUDGET_MLP = 0.5
# cfg.MODEL.BUDGET_PATCH = 0.5
# # TRAIN
# cfg.TRAIN = edict()
# cfg.TRAIN.LR = 0.0001
# cfg.TRAIN.TRAIN_CLS_MODEL = False
# cfg.TRAIN.TRAIN_CLS_SAMP = True
...
# cfg.TRAIN.DECODER_MULTIPLIER = 0.01
# cfg.TRAIN.ENCODER_MULTIPLIER = 1
# cfg.TRAIN.GIOU_WEIGHT = 2.0
# cfg.TRAIN.L1_WEIGHT = 5.0
# cfg.TRAIN.CLF_WEIGHT = 3.0
...
# cfg.TRAIN.CONV_PRUNE = False
# cfg.TRAIN.TRANS_PRUNE = False
# cfg.TRAIN.SPARSITY = 1e-5
# cfg.TRAIN.W1_ENC = 1e-4
# cfg.TRAIN.W2_ENC = 1e-4
# cfg.TRAIN.W1_DEC = 1e-4
# cfg.TRAIN.W2_DEC = 1e-4
# cfg.TRAIN.W3 = 0
# # TRAIN.SCHEDULER
...
cfg.MODEL.TRANSFORMER.NHEADS = 8
cfg.MODEL.TRANSFORMER.DROPOUT = 0.1
cfg.MODEL.TRANSFORMER.DIM_FEEDFORWARD = [768]
cfg.MODEL.TRANSFORMER.ENC_LAYERS = 3
cfg.MODEL.TRANSFORMER.DEC_LAYERS = 3
cfg.MODEL.TRANSFORMER.PRE_NORM = False
cfg.MODEL.TRANSFORMER.DIVIDE_NORM = False
cfg.MODEL.HEAD_SEARCH = False
cfg.MODEL.UNIFORM_SEARCH = False
