...
from lib.models.stark import build_starkst,build_starkst_sparse
...
class STARK_ST(BaseTracker):
    def __init__(self, params, dataset_name):
        ...
        network = build_starkst_sparse(params.cfg)
#         print(self.params.checkpoint)
        network.load_state_dict(torch.load(self.params.checkpoint, map_location='cpu')['net'], strict=True)
        thresh_attn,thresh_mlp,thresh_patch = network.transformer.compress_layerwise(0.1,0.1,0.5)
        self.cfg = params.cfg
